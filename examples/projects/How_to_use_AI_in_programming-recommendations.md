...
- být schopen řešení vysvětlit a obhájit při technické demonstraci.
...
| `task-NNN/report.md` | **Doporučuji** napsat po dokončení každého projektu. | Forced retrospection — pomůže pak odpovídat *"proč jste to udělal takhle"*. |
...
Pokud to napíše AI, nenaučíte se nic, co by vám pomohlo v praxi s konverzačními agenty.
...
Zde je AI rychlejší a vy se nic nového nenaučíte (resp. to není to, co se chcete naučit pro konverzační agenty).
...
## Speciální doporučení: časově omezená simulace
...
Pokud plánujete technickou demonstraci s časovým limitem, je dobré vědět dopředu, jak rychle pracujete bez AI asistenta.
...
Cíl: nejen znalosti, ale **reálná důvěra** ve vlastní schopnosti. Při technické demonstraci musíte vědět, **proč** je váš kód takový, jaký je, a umět to vysvětlit.

## Pro workshop / technickou demonstraci

- AI tools budou pravděpodobně povoleny.
- Kód budete **vysvětlovat live**, často s follow-up úpravami.
