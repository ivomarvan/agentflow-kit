...
# Run:
#     uv run python examples/framework/03_live_graph.py -h           # help
#     uv run python examples/framework/03_live_graph.py run          # run workflow
#     uv run python examples/framework/03_live_graph.py graph --browser
#     uv run python examples/framework/03_live_graph.py graph -o graph.html
