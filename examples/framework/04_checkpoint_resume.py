...
# Run:
#     uv run python examples/framework/04_checkpoint_resume.py -h           # help
#     uv run python examples/framework/04_checkpoint_resume.py run          # run workflow
#     uv run python examples/framework/04_checkpoint_resume.py graph --browser
#     uv run python examples/framework/04_checkpoint_resume.py graph -o graph.html
