...
# Run:
#     uv run python examples/agents/06_smart_home_live.py run
#     uv run python examples/agents/06_smart_home_live.py graph --browser
#     uv run python examples/agents/06_smart_home_live.py gui
#     uv run python examples/agents/06_smart_home_live.py -h
